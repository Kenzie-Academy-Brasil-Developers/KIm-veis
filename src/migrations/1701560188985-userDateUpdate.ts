...
export class UserDateUpdate1701560188985 implements MigrationInterface {
    name = 'UserDateUpdate1701560188985'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "real_estate" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "sold" boolean NOT NULL DEFAULT (0), "value" decimal(12,2) NOT NULL DEFAULT (0), "size" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "categoryId" integer, "addressId" integer, CONSTRAINT "REL_44ae17efa35575b6a6f83b35ee" UNIQUE ("addressId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_real_estate" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "sold" boolean NOT NULL DEFAULT (0), "value" decimal(12,2) NOT NULL DEFAULT (0), "size" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "categoryId" integer, "addressId" integer, CONSTRAINT "REL_44ae17efa35575b6a6f83b35ee" UNIQUE ("addressId"), CONSTRAINT "FK_e64472d578faf91bee90a06ecc0" FOREIGN KEY ("categoryId") REFERENCES "categories" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_44ae17efa35575b6a6f83b35ee5" FOREIGN KEY ("addressId") REFERENCES "addresses" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_real_estate"("id", "sold", "value", "size", "createdAt", "updatedAt", "categoryId", "addressId") SELECT "id", "sold", "value", "size", "createdAt", "updatedAt", "categoryId", "addressId" FROM "real_estate"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "real_estate" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "sold" boolean NOT NULL DEFAULT (0), "value" decimal(12,2) NOT NULL DEFAULT (0), "size" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "categoryId" integer, "addressId" integer, CONSTRAINT "REL_44ae17efa35575b6a6f83b35ee" UNIQUE ("addressId"))`);
        await queryRunner.query(`INSERT INTO "real_estate"("id", "sold", "value", "size", "createdAt", "updatedAt", "categoryId", "addressId") SELECT "id", "sold", "value", "size", "createdAt", "updatedAt", "categoryId", "addressId" FROM "temporary_real_estate"`);
